...
#: ★ **2026-08-28 에 다시 재서 1.0 → 2.0 으로 올렸다.**
#:   그날 90610953 이 `요청 79 · 수확 0 · 실패 79 · 92초`(건당 **1.16초**)로
#:   끝났는데 문턱이 1.0 이라 **아슬아슬하게 안 걸렸고** 감시자는 `정상`
#:   이라 말했다.  되보고 `최근` 100줄을 겹침 뺀 35회차로 다시 재니 **틈이 넓다**:
#:     헛돈 회차 5개 = 0.10 · 0.14 · 0.14 · 1.16 · 1.22 초/건
#:     정상 회차 30개 = **2.86** · 2.92 · 3.85 … 14.71 · 22.91 초/건
#:   (2.86 은 84789192 의 `수확 59/59 · 실패 0` — 완전히 성공한 회차다)
#:   문턱은 **1.22 와 2.64 사이**여야 한다(2.64 는 2026-08-26 실측 최저 정상치 —
#:   지금 창에는 없지만 그때 재 것도 사실이라 버리지 않는다 · [169]).
#:   **2.0** 은 헛돈 최대(1.22)의 1.64배 · 정상 최저(2.64)의 0.76배다.
#: ★ 올려도 **정당한 `수확 0` 은 그대로 조용하다**([172] — 좁히는 것도 고장이다).
#:   실측으로 2.0 위인데 수확이 0 인 회차가 **13개** 있고 그것들은 그대로 안 걸린다.
BLANK_ROUND_SEC_PER_POST = 2.0
