/* ── 밴드 90610953 댓글 실증 + 새 글 확인 + 구멍 — 이 파일 전체를 복사해 밴드 탭 콘솔(F12)에 붙여넣으세요 ──
 * 붙여넣는 즉시 시작하고 **끝까지 알아서 갑니다**. 붙여넣기는 이 한 번뿐입니다.
 *   14건 · 1회차(회차당 최대 250건) · 대략 1분.
...
(function () {
  const ROUNDS = [[4369, 5233, 4770, 4387, 5452, 3525, 3397, 3378, 3374, 3373, 2598, 2597, 2595, 2573]];
  const BAND = 90610953;
