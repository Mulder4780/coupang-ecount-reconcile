// 오염복구 붙여넣기 — 2026-08-24 생성 (수집 세션)
// 무엇: 캐시가 오염돼 화면에서 사라진 글을 다시 받는다. 번호는 앱의
//       /api/collect_plan 대기열 그대로다(make_oneclick 의 오염 거르기를 안 거친다).
// ★ 이 파일은 워치독이 안 갱신한다(이름에 '붙여넣기'가 없어 훑지 않는다).
//   수집 규칙이 바뀌면 낡는다 — 그때는 다시 만든다. 근거: 분담판 [209]
/* ── 밴드 90610953 최근 30일 재수집 — 이 파일 전체를 복사해 밴드 탭 콘솔(F12)에 붙여넣으세요 ──
 * 붙여넣는 즉시 시작하고 **끝까지 알아서 갑니다**. 붙여넣기는 이 한 번뿐입니다.
 *   3건 · 1회차(회차당 최대 250건) · 대략 0분.
 *   위쪽 근거: 근거가 낡음(2026-08-20 확인 · 3일 지남). 아직 없는 번호는 한 개당 21초를 무는데 수확이
...
(function () {
  const ROUNDS = [[5360, 5361, 5362, 5363, 5400, 5401, 5402, 5403, 5404, 5405, 5406, 5407, 5408, 5409, 5420, 5369, 5370, 5371, 5372, 5373, 5374, 5375, 5376, 5377, 5378, 5379, 5380, 5381, 5382, 5383, 5384, 5385, 5386, 5387, 5389, 5390, 5391, 5392, 5393, 5394], [5395, 5396, 5397, 5398, 5399, 5410, 5411, 5412, 5413, 5414, 5415, 5423, 5424, 5425, 5426, 5427, 5432, 5433, 5434, 5435, 5436, 5437, 5438, 5439, 5440, 5442, 5443, 5444, 5445, 5446, 5447, 5452, 5453, 5454, 5455, 5456, 5457, 5458, 5459, 5460], [5461, 5462, 5463, 5464, 5465, 5466, 5467, 5468, 5469, 5470, 5471, 5472, 5473, 5474, 5475, 5476, 5477, 5478, 5479, 5233]];
  const BAND = 90610953;
